...
```bash
$ bash .claude/skills/task-management/router.sh complete my-feature 05 "Implemented authentication module"
...
```bash
$ bash .claude/skills/task-management/router.sh deps my-feature 07
...
```bash
bash .claude/skills/task-management/router.sh validate my-feature
```
...
bash .claude/skills/task-management/router.sh status my-feature

# See what's next
bash .claude/skills/task-management/router.sh next my-feature

# Check what's blocked
bash .claude/skills/task-management/router.sh blocked my-feature
```
...
bash .claude/skills/task-management/router.sh complete my-feature 05 "Implemented auth module with JWT support"
...
bash .claude/skills/task-management/router.sh parallel my-feature
```
...
- **Skill**: `.claude/skills/task-management/`
- **Router**: `.claude/skills/task-management/router.sh`
- **CLI**: `.claude/skills/task-management/scripts/task-cli.js`
- **Tasks**: `.tmp/tasks/` (created by TaskManager)
- **Documentation**: `.claude/skills/task-management/SKILL.md` (this file)
