...
Enhanced fields (line-number precision, domain modeling, contracts) can be added as optional extensions to this base schema. All enhanced fields are **optional** and backward compatible.
