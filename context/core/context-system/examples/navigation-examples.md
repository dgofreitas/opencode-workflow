...
**File**: `project-intelligence/navigation.md`
...
Visual Design (development/frontend/):
...
| **Animations** | `../../core/standards/code-quality.md` |
| **Styling** | `../../core/standards/code-quality.md` |
...
```
Frontend: development/frontend/react/ + core/standards/code-quality.md
...
3. `core/standards/code-quality.md` (styling)
```
