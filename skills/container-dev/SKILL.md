---
name: container-dev
description: Standardize MoneyTrackr container-based development. Use when running docker compose, building images, debugging service startup, or deciding dev vs prod mode. Triggers: container, compose, docker, dev mode, build image, deploy local.
---

# MoneyTrackr Container Development
...
```bash
# Build prod images
bash scripts/build-imgages.sh frontend production
bash scripts/build-imgages.sh backend production
