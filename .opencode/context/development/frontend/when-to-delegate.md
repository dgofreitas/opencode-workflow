<!-- Context: development/frontend/when-to-delegate | Priority: high | Version: 2.0 | Updated: 2026-03-29 -->
# When to Delegate to FrontendDeveloper Agents

## Overview

Clear decision criteria for when to delegate frontend/UI work to the **FrontendDeveloper** subagent vs. handling it directly.

## Quick Reference

**Delegate to FrontendDeveloper when**:
...
Before delegating to FrontendDeveloper, ensure:
...
If you're unsure what context the FrontendDeveloper will need:
...
**Approach**: Delegate to FrontendDeveloper subagent
...
**Context Needed**:
- Design system standards (core/standards/code-quality.md (load design system from project context))
- UI styling standards (core/standards/code-quality.md (load styling from project context))
- Animation patterns (core/standards/code-quality.md (load animation patterns from project context))
...
**Decision**: ✅ Delegate to FrontendDeveloper
...
You: [Propose approach] → [Get approval] → [Delegate to FrontendDeveloper]
```
...
## Context Files FrontendDeveloper Uses

The FrontendDeveloper will automatically load these via ContextScout:

**Design System**:
- `core/standards/code-quality.md (load design system from project context)` - Theme templates, color systems
- `core/standards/code-quality.md (load styling from project context)` - Tailwind, Flowbite, responsive design
- `core/standards/documentation.md (load design assets from project context)` - Images, icons, fonts

**Patterns**:
- `core/standards/code-quality.md (load animation patterns from project context)` - Animation syntax, micro-interactions
- `development/frontend/react/react-patterns.md` - React patterns (if React project)

**Workflows**:
- `core/workflows/task-delegation-specialists.md` - When to delegate to which agent
...
- ✅ **Use staged workflow** - Let FrontendDeveloper follow its process
...
- **Design Systems** → `../../core/standards/code-quality.md (load design system from project context)`
- **UI Styling Standards** → `../../core/standards/code-quality.md (load styling from project context)`
- **Animation Patterns** → `../../core/standards/code-quality.md (load animation patterns from project context)`
